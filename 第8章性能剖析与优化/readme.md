...
# python3'u'，Py_UNICODE，Unicode character ，2字节
```
...
pool.putRequest(
    threadpool.WorkRequest(download_file, args=["http://chrisarndt.de/projects/threadpool/api/", ]))  # 将具体的请求放入线程池
